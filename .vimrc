...
Plug 'acgissues/contrastneed-theme'
...
Plug 'vim345/vim', { 'as': 'vim345-vim' }
Plug 'mhinz/vim-janah'
Plug 'GGalizzi/cake-vim'
Plug 'mkarmona/colorsbox'
Plug 'mkarmona/materialbox'
Plug 'vim-scripts/moria'
Plug 'loogica/vim_themes'
...
Plug 'Konstruktionist/vim', { 'as': 'konstruktionist-vim' } 
...
Plug 'vim-scripts/darkslategray.vim'
